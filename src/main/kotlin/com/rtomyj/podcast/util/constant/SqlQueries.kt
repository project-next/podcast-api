...
object SqlQueries {
	...
	val INSERT_NEW_PODCAST_QUERY =
		"INSERT INTO $PODCAST_INFO_TABLE(${PodcastInfoTableColumns.PODCAST_ID}, $PODCAST_TITLE, $PODCAST_LINK, $PODCAST_DESCRIPTION, $PODCAST_LANGUAGE, $PODCAST_COPYRIGHT, $PODCAST_LAST_BUILD_DATE, $PODCAST_EMAIL, $PODCAST_CATEGORY, $PODCAST_AUTHOR, ${PodcastInfoTableColumns.IS_EXPLICIT}, $PODCAST_IMAGE_URL) VALUES (:podcast_id,:podcast_title, :podcast_link, :podcast_description, :podcast_language, :podcast_copyright, NOW(), :podcast_email, :podcast_category, :podcast_author, :is_explicit, :podcast_image_url)"
	val UPDATE_PODCAST_QUERY =
		"UPDATE $PODCAST_INFO_TABLE SET $PODCAST_TITLE = :podcast_title, $PODCAST_LINK = :podcast_link, $PODCAST_DESCRIPTION = :podcast_description, $PODCAST_LANGUAGE = :podcast_language, $PODCAST_COPYRIGHT = :podcast_copyright, $PODCAST_LAST_BUILD_DATE = NOW(), $PODCAST_EMAIL = podcast_email, $PODCAST_CATEGORY = podcast_category, $PODCAST_AUTHOR = podcast_author, ${PodcastInfoTableColumns.IS_EXPLICIT} = is_explicit, $PODCAST_IMAGE_URL = podcast_image_url WHERE ${PodcastInfoTableColumns.PODCAST_ID} = :podcast_id"
}