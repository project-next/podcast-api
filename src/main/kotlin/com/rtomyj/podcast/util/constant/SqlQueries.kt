...
object SqlQueries {
	...
	val INSERT_NEW_PODCAST_QUERY =
		"INSERT INTO $PODCAST_INFO_TABLE(${PodcastInfoTableColumns.PODCAST_ID}, $PODCAST_TITLE, $PODCAST_LINK, $PODCAST_DESCRIPTION, $PODCAST_LANGUAGE, $PODCAST_COPYRIGHT, " +
				"$PODCAST_LAST_BUILD_DATE, $PODCAST_EMAIL, $PODCAST_CATEGORY, $PODCAST_AUTHOR, ${PodcastInfoTableColumns.IS_EXPLICIT}, $PODCAST_IMAGE_URL) VALUES (:podcast_id, " +
				":podcast_title, :podcast_link, :podcast_description, :podcast_language, :podcast_copyright, NOW(), :podcast_email, :podcast_category, :podcast_author, " +
				":is_explicit, :podcast_image_url)"
}