...
enum class PodcastApiTables(
	...
	enum class PodcastEpisodeTableColumns(
		...
		EPISODE_TITLE("episode_title"), PODCAST_ID("podcast_id"), EPISODE_WEBPAGE_LINK("episode_webpage_link"), EPISODE_AUDIO_LINK("episode_audio_link"), EPISODE_DESCRIPTION("episode_description"), EPISODE_PUBLICATION_DATE("episode_pub_date"), EPISODE_AUTHOR(
			"episode_author"
		),
