...
)
{
    ...
    , PODCAST_EPISODES_TABLE("podcast_episode");
    ...
    )
    {
        ...
        , PODCAST_LAST_BUILD_DATE("podcast_last_build_date")
    ...
    )
    {
        ...
        , EPISODE_PUBLICATION_DATE("episode_pub_date")
        , EPISODE_AUTHOR("episode_author")
        , EPISODE_IMAGE("episode_image")
        , EPISODE_KEYWORDS("episode_keywords")
        , EPISODE_GUID("episode_guid")
        , EPISODE_LENGTH("episode_length")
        , EPISODE__MEDIA_TYPE("episode_media_type")
        , IS_EXPLICIT("is_episode_explicit")
